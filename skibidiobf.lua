...
function obfuscate(source,VarName,WaterMark)
        ...
        local Variable = VarName or "Bread_"
        local WM
        ...
        if typeof(WaterMark) == "string" and WaterMark ~= nil then
            WM = "    "..tostring(WaterMark).." BreadMages"
        else
            WM = "    ".."WaterMark".." BreadMages"
        end
        ...
        local add_binary = function(number, s)
            ...
            local topic = {
                ...
                "you got haxxed!",
                "moonsec? more like moonsex.",
                "nice obfuscator 0⥿0",
                "Understandable: ✖︎",
                "JaylerTheSigma3000 fr",
                "Rv gonna freak out when he see breadmages!!1!1!11",
                "Skibidi toilet",
                "X[l];o[e[n]]=c[e[4]];l=l+n;e=X[l];o[e[n]]=o[e[4]]-o[e[2]];l=l+n;e=X[l];o[e[n]]=o[e[4]][e[2]];l=l+n;e=X[l];o[e[n]]=o[e[4]]+o[e[2]];l=l+n;e=X[l];A=e[n]o[A]=o[A](S(o,A+n,e[4]",
